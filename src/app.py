...
def load_vocabs():
    with open("vocab_src_char.json", "r", encoding="utf-8") as f:
        v_src = json.load(f)
    with open("vocab_tgt_char.json", "r", encoding="utf-8") as f:
        v_tgt = json.load(f)
    stoi_src = v_src["stoi"]
    itos_tgt = v_tgt["itos"]
...
def load_model_and_meta():
    ...
    ckpt_path = "bilstm4lstm_char_E256_H256_enc2_dec4_drop0.3_best.pt"
